...
class GameWindow(Screen):
    ...
    def choose_atout(self):
        ...
        self.Spade = Button(text="spade", size_hint=(0.3,0.1), pos=(300,200), font_size=(self.width + self.height)/5,background_color=(1,0,1,0.95))
        self.Spade.bind(on_press=choose_spade)
        self.Heart = Button(text="heart", size_hint=(0.3,0.1), pos=(100,300), font_size=(self.width + self.height)/5,background_color=(0,0,1,0.95))
        self.Heart.bind(on_press=choose_heart)
        self.Diamond = Button(text="diamond", size_hint=(0.3,0.1), pos=(300,400), font_size=(self.width + self.height)/5,background_color=(1,0,0,0.95))
